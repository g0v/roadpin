...
import logging
import unittest
from app.http_handlers import g_json_by_geo_handler

class TestGJsonByGeoHandler(unittest.TestCase):
    '''unit tests for g_json_by_geo_handler'''
    ...
    def test_g_json_by_geo_handler_true(self):
