...
import logging
import unittest
from app.http_handlers import post_add_handler

class TestPostAddHandler(unittest.TestCase):
    '''unit tests for post_add_handler'''
    ...
    def test_post_add_handler_true(self):
