...
import logging
import unittest
from app.http_handlers import g_json_sketch_handler

class TestGJsonSketchHandler(unittest.TestCase):
    '''unit tests for g_json_sketch_handler'''
    ...
    def test_g_json_sketch_handler_true(self):
