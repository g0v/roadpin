...
import logging
import unittest
from app.http_handlers import g_json_by_id_list_handler

class TestGJsonByIdListHandler(unittest.TestCase):
    '''unit tests for g_json_by_id_list_handler'''
    ...
    def test_g_json_by_id_list_handler_true(self):
