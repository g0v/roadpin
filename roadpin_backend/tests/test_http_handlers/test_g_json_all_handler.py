...
import logging
import unittest
from app.http_handlers import g_json_all_handler

class TestGJsonAllHandler(unittest.TestCase):
    '''unit tests for g_json_all_handler'''
    ...
    def test_g_json_all_handler_true(self):
