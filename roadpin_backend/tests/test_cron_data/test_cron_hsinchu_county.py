...
import logging
import unittest
from app.cron_data import cron_hsinchu_county

class TestCronHsinchuCounty(unittest.TestCase):
    '''unit tests for cron_hsinchu_county'''
    ...
    def test_cron_hsinchu_county_true(self):
