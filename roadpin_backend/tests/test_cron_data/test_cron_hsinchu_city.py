...
import logging
import unittest
from app.cron_data import cron_hsinchu_city

class TestCronHsinchuCity(unittest.TestCase):
    '''unit tests for cron_hsinchu_city'''
    ...
    def test_cron_hsinchu_city_true(self):
