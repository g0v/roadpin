...
import logging
import unittest
from app.cron_data import cron_chiayi_county

class TestCronChiayiCounty(unittest.TestCase):
    '''unit tests for cron_chiayi_county'''
    ...
    def test_cron_chiayi_county_true(self):
