...
import logging
import unittest
from app.cron_data import cron_new_taipei_city

class TestCronNewTaipeiCity(unittest.TestCase):
    '''unit tests for cron_new_taipei_city'''
    ...
    def test_cron_new_taipei_city_true(self):
