...
import logging
import unittest
from app.crawlers.new_taipei_city import crawler_new_taipei_city_report

class TestCrawlerNewTaipeiCityReport(unittest.TestCase):
    '''unit tests for crawler_new_taipei_city_report'''
    ...
    def test_crawler_new_taipei_city_report_true(self):
