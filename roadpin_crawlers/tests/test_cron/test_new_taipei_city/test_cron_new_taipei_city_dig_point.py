...
import logging
import unittest
from app.cron.new_taipei_city import cron_new_taipei_city_dig_point

class TestCronNewTaipeiCityDigPoint(unittest.TestCase):
    '''unit tests for cron_new_taipei_city_dig_point'''
    ...
    def test_cron_new_taipei_city_dig_point_true(self):
